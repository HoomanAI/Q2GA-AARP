"""Run GA / SA / QGA / Q2GA on the Ottawa case-study instance and save:
...
from src.ottawa_instance import build_instance  # noqa: E402
...
# Ottawa case study has N=25 patients, between the medium (30) and small (15)
