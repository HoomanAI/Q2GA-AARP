% make_all_figs.m
% Regenerates all Ottawa case-study figures (white background) as MATLAB
...
title('Convergence comparison -- Ottawa case study (N=25 patients)');
...
title('Final-fitness distribution -- Ottawa case study (10 seeds)');
set(gca,'Color','w');
...
ylabel('Mean value');
title('Objective-component breakdown -- Ottawa case study (mean over 10 seeds)');
...
title('Runtime comparison -- Ottawa case study (10 seeds)');
set(gca,'Color','w');
...
xlabel('x (km, east of Ottawa city centre)');
ylabel('y (km, north of Ottawa city centre)');
title('Ottawa case-study instance layout');
...
title('Patient-type composition -- Ottawa case study');
set(gca,'Color','w');
...
title('Semi-soft time-window thresholds -- Ottawa case study');
set(gca,'Color','w');
...
title('Semi-soft time-window delay-penalty function -- Ottawa case study');
legend('Location','best');
set(gca,'Color','w');
...
title(sprintf('Realised disruption scenario -- Ottawa case study (Gamma=%d of %d, MTTR=%g)', ...
...
sgtitle('Impact of cyber-disruption breadth (Gamma) on quality of service -- Ottawa case study (Q2GA, 5 seeds)');
...
title('Recovery time (MTTR) and resulting availability vs. quality of service -- Ottawa case study (Q2GA, 5 seeds)');
legend('Location','best');
set(gca,'Color','w');
...
plot(double(d.default_mttr), double(d.default_mtbf), 'kx', 'MarkerSize', 14, 'LineWidth', 3, ...
     'DisplayName', sprintf('Ottawa operating point (MTTR=%.0f, MTBF=%.0f)', double(d.default_mttr), double(d.default_mtbf)));
...
title('Quality-of-service degradation under worsening cyber-risk conditions -- Ottawa case study (Q2GA, 5 seeds)');
legend('Location','best');
set(gca,'Color','w');
