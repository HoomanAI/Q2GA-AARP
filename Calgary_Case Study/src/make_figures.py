...
companion .mat files for the Calgary case study:
...
def plot_convergence(conv_df):
    ...
    ax.set_title("Convergence comparison -- Calgary case study (N=25 patients)")
    ax.legend()
    fig.tight_layout()
...
def plot_boxplot(summ_df):
    ...
    ax.set_title("Final-fitness distribution -- Calgary case study (10 seeds)")
    fig.tight_layout()
...
def plot_objectives(summ_df):
    ...
    ax.set_title("Objective-component breakdown -- Calgary case study (mean over 10 seeds)")
    ax.legend()
    fig.tight_layout()
...
def plot_runtime(summ_df):
    ...
    ax.set_title("Runtime comparison -- Calgary case study (10 seeds)")
    fig.tight_layout()
